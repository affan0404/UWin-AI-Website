...
export default function CornerNeuralPage() {
  ...
  const handleBackClick = () => {
    // Use window.history.back() for a more immediate navigation experience
    // This uses the browser's history API directly instead of Next.js router
    window.history.back();
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-8 text-blue-900 overflow-hidden relative">
      ...
      <div className="relative max-w-3xl mx-auto my-16 bg-white p-10 rounded-lg shadow-sm border border-blue-100 z-10">
        ...
        <h2 className="text-3xl font-serif font-bold mb-6 text-blue-800">
          First Ever Merch Drop
        </h2>
        <p className="leading-relaxed text-lg text-blue-700 font-semi-bold">
        The AI Clubs first merch drop includes sleek, high-quality hoodies and a variety of AI-themed stickers. Designed with a futuristic touch, they let you represent your passion for AI in style. Proceeds support club projects, workshops, and events, helping us build a stronger community.
        </p>
