  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white p-8 text-blue-900 overflow-hidden relative">
      ...
      <div className="relative max-w-3xl mx-auto my-16 bg-white p-10 rounded-lg shadow-sm border border-blue-100 z-10">
        ...
        The AI Club fosters hands-on learning through project-based exploration of AI concepts. Each month, members build practical applications, gaining deeper insights into machine learning and NLP. A key project, Tutor Bot, uses AI to assist students with academic queries, enhancing both its accuracy and members’ backend development skills. Through such initiatives, the club drives innovation and real-world AI applications.
        </p>
